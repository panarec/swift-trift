...
export const getGame = async (currentLevel: number) => {
    ...
    const responseData = await sendPostRequest(body, '/api/getGame')
...
export const move = async (
    ...
    const responseData = await sendPostRequest(body, '/api/move')
...
export const finnishGame = async (
    ...
    const responseData = await sendPostRequest(body, '/api/finnishGame')
